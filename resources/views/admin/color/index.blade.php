                        ...
                        <table id="datatablesSimple" class="text-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$color->name}}</td>
                                    <td>
                                        <a href="{{route('color.edit',$color->id)}}" class="btn btn-edit btn-sm"><i class="fas fa-edit"></i></a> 
                                        <button type="submit" class="btn btn-delete" onclick="deleteUser({{ $color->id }})"><i class="far fa-trash-alt"></i></button>
                                        <form id="delete-form-{{ $color->id }}" action="{{ route('color.destroy', $color->id) }}"
