                            ...
                            <form action="{{route('order.edit',$d_order->id)}}" method="POST">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('product.order.cancel',$d_order->id)}}" title="Delete" onclick="return confirm('Are you sure! Delete this data')" class="btn btn-delete" ><i class="fas fa-trash"></i></a>
                                     </td>
                                </tr>
                            </form>
                        @endforeach
