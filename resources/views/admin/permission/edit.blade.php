        ...
        <form action="{{route('permission.store',$user->id)}}" method="post">
            ...
            <div class="row m-3">
                ...
                <div class="col-md-4 mt-2">
                    ...
                    <div class="form-check">
                        <input class="form-check-input-2" type="checkbox" value="{{$page->id}}" name="page_id[]" id="flexCheckDefault"/>
                        <label class="form-check-label" for="flexCheckDefault">
                        {{$page->display_name}}
                        </label>
                    </div>
                ...
                <div class="col-md-4 mt-2">
                    ...
                    <div class="form-check">
                        <input class="form-check-input-3" type="checkbox" value="{{$page->id}}" name="page_id[]" id="flexCheckDefault"/>
                        <label class="form-check-label" for="flexCheckDefault">
                        {{$page->display_name}}
                        </label>
                    </div>
                ...
                <div class="col-md-4 mt-2">
                    ...
                    <div class="form-check">
                        <input class="form-check-input-4" type="checkbox" value="{{$page->id}}" name="page_id[]" id="flexCheckDefault"/>
                        <label class="form-check-label" for="flexCheckDefault">
                        {{$page->display_name}}
                        </label>
                    </div>
                ...
                <div class="col-md-4 mt-2">
                    ...
                    <div class="form-check">
                        <input class="form-check-input-5" type="checkbox" name="page_id[]" value="{{$page->id}}" id="flexCheckDefault"/>
                        <label class="form-check-label" for="flexCheckDefault">
                        {{$page->display_name}}
                        </label>
                    </div>
                ...
                <div class="col-md-4 mt-2">
                    ...
                    <div class="form-check">
                        <input class="form-check-input-6" type="checkbox" name="page_id[]" value="{{$page->id}}" id="flexCheckDefault"/>
                        <label class="form-check-label" for="flexCheckDefault">
                        {{$page->display_name}}
                        </label>
                    </div>
